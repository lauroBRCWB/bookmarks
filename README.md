...
4. Nassim Taleb, Antifragility: **on regulation/deregulation**: *Some libertarians use the example of Drachten, a town in the Netherlands, in which a dream experiment was conducted. All street signs were removed. Thje deregulation led to an increase in safety, confirming the antifragility of attention at work, how it is whetted by a sense of danger and responsibility. As a result, **many German and Dutch** towns have reduced the number of street signs. (...) But one needs to be careful not to overgeneralize the Drachten effect, as it does not imply the effectiveness of removing all rules from society.*
5. Nassim Taleb, Antifragility: **on procrastination**: *One general, Fabius Maximus was nicknamed Cunctator, "the Procrastinator". He drove Hannibal, who had an obvious military superiority, crazy by avoiding and delaying engagement. (...) A very intelligent group of revolutionary fellows in the United Kindom created a political movement called the Fabian Society, named after the Cunctator, based on opportunistically delaying the revolution.*
6. Nassim Taleb, Antifragility: **on noise**: *Consider the iatrogenics of newspapers. They need to fill their pages everyday with a set of new items - particularly those new items also dealt with by others newspapers. **But to do things right, they ought to learn to keep silent in the absense of news of significance.***
7. Felipe Miranda: A parte ruim de você ler teses de pessoas muito mais inteligentes é que você acaba concordando com várias delas, sendo que, em muitas situações, uma representa a antítese da outra.
8. Nassim Taleb, Antifragility: **on stoicism**: *(...) someone who transforms fear into prudence, pain into transformation, mistakes into initiation and desire into undertaking. (...)* **on tricks** *separate anger from rightful action (...) invest in good actions*
9. Nassim Taleb, Antifragility: **on building better personality**: *after the occurrence of an event, we need to switch the blame from the inability to see an event coming to the failure to understand antifragility.*
10. Nassim Taleb, Antifragility: **where antifragility is found**: *some people in the nuclear industry seem to be among the rare ones to have gotten the point and taken it to its logical consequence. In the wake of the Fukushima disaster, instead of predicting failure and the probabilities of disaster, these intelligent nuclear firms are now aware that they should instead focus on exposure to failure.*
11. Nassim Taleb, Antifragility: **how to control fragility**: *(i) have things that don't fall apart, or even benefit, when we make a mistake; (ii) make things more robust to defects and forecast errors, or even exploit these errors, making limonade out of the lemons; (iii) time.*
